...
//2、建立连接  
// mongoose.connect('mongodb://eggadmin:123456@127.0.0.1:27017/eggcms',{ useNewUrlParser: true });
...
const User=mongoose.model('User',UserSchema,'user');  //默认会操作第三个参数配置的表  user表（集合）
...
//6、增加数据
// 6.1实例化 Model     通过实例化User Model 创建增加的数据
// 6.2 实例.save()
const  u=new User({
    name:'李四',
    age:20,
